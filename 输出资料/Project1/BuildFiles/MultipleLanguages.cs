...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class MultipleLanguages : Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageServer, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage
	{
		...
		{
			this.DataBindings.Add(new Neo.ApplicationFramework.Common.Data.DynamicBinding("LanguageIndex", ((Neo.ApplicationFramework.Common.Data.RealtimeDataItemProxy)(Neo.ApplicationFramework.Common.Data.DataItemProxyFactory.CreateRealtimeProxy("Tags.LID"))), "Value", true, System.Windows.Forms.DataSourceUpdateMode.Never, new Neo.ApplicationFramework.Common.Dynamics.ExpressionConverter("LIDPLUS1")));
			...
			LanguageInfo1.Name = "Chinese (Simplified, China)";
			...
			LanguageInfo2.Name = "English (United States)";
