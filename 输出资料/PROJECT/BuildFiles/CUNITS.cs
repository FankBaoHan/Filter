...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class CUNITS : Neo.ApplicationFramework.Controls.Controls.Form, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage {
        ...
        private bool m_Initialized_CUNITS;
        ...
        private void InitializeComponent() {
            ...
            this.m_Button.ScreenOwnerName = "CUNITS";
            ...
            this.m_Button1.ScreenOwnerName = "CUNITS";
            ...
            this.m_Button2.ScreenOwnerName = "CUNITS";
            ...
            this.m_Button3.ScreenOwnerName = "CUNITS";
            ...
            this.m_Button4.ScreenOwnerName = "CUNITS";
            ...
            this.m_Text.ScreenOwnerName = "CUNITS";
            ...
            this.ScreenID = null;
            this.ScreenTitle = "Config unit select";
            this.StyleName = "Default";
            this.WindowState = System.Windows.Forms.FormWindowState.Normal;
            this.m_Initialized_CUNITS = true;
        ...
        private void m_Button_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button", "Click", "Show Screen", "CONFIG1_1", "");
            Neo.ApplicationFramework.Generated.Globals.CONFIG1_1.Show();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(CUNITS));
            this.m_Button.Text = resources.GetText("CUNITS.Button.Text", "1");
            this.m_Button1.Text = resources.GetText("CUNITS.Button1.Text", "1");
            this.m_Button2.Text = resources.GetText("CUNITS.Button2.Text", "1");
            this.m_Button3.Text = resources.GetText("CUNITS.Button3.Text", "1");
            this.m_Button4.Text = resources.GetText("CUNITS.Button4.Text", "1");
            this.m_Text.Text = resources.GetText("CUNITS.Text.Text", "请选择待设置模块");
            resources.ApplyTexts(this.m_Button, "Texts", "CUNITS.Button.Texts[0]", "模块1", "CUNITS.Button.Texts[1]", "Unit1");
            resources.ApplyTexts(this.m_Button1, "Texts", "CUNITS.Button1.Texts[0]", "模块2", "CUNITS.Button1.Texts[1]", "Unit2");
            resources.ApplyTexts(this.m_Button2, "Texts", "CUNITS.Button2.Texts[0]", "模块3", "CUNITS.Button2.Texts[1]", "Unit3");
            resources.ApplyTexts(this.m_Button3, "Texts", "CUNITS.Button3.Texts[0]", "模块4", "CUNITS.Button3.Texts[1]", "Unit4");
            resources.ApplyTexts(this.m_Button4, "Texts", "CUNITS.Button4.Texts[0]", "模块5", "CUNITS.Button4.Texts[1]", "Unit5");
            resources.ApplyTexts(this.m_Text, "Texts", "CUNITS.Text.Texts[0]", "请选择待设置模块", "CUNITS.Text.Texts[1]", "Please select a unit");
