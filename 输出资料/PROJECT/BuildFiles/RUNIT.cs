...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class RUNIT : Neo.ApplicationFramework.Controls.Controls.Form, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage {
        ...
        private bool m_Initialized_RUNIT;
        ...
        private void InitializeComponent() {
            ...
            this.m_Button.ScreenOwnerName = "RUNIT";
            ...
            this.m_Button1.ScreenOwnerName = "RUNIT";
            ...
            this.m_Button2.ScreenOwnerName = "RUNIT";
            ...
            this.m_Button3.ScreenOwnerName = "RUNIT";
            ...
            this.m_Button4.ScreenOwnerName = "RUNIT";
            ...
            this.m_Text.ScreenOwnerName = "RUNIT";
            stringintervalmappercf6.DefaultValue = "请选择待初始化模块";
            stringintervalcf11.Value = "请选择待初始化模块";
            ...
            this.ScreenID = null;
            this.ScreenTitle = "Factory settings";
            this.StyleName = "Default";
            this.WindowState = System.Windows.Forms.FormWindowState.Normal;
            this.m_Initialized_RUNIT = true;
        ...
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(RUNIT));
            this.m_Button.Text = resources.GetText("RUNIT.Button.Text", "1");
            this.m_Button1.Text = resources.GetText("RUNIT.Button1.Text", "1");
            this.m_Button2.Text = resources.GetText("RUNIT.Button2.Text", "1");
            this.m_Button3.Text = resources.GetText("RUNIT.Button3.Text", "1");
            this.m_Button4.Text = resources.GetText("RUNIT.Button4.Text", "1");
            this.m_Text.Text = resources.GetText("RUNIT.Text.Text", "请选择待初始化模块");
            resources.ApplyTexts(this.m_Button, "Texts", "RUNIT.Button.Texts[0]", "模块1", "RUNIT.Button.Texts[1]", "Unit1");
            resources.ApplyTexts(this.m_Button1, "Texts", "RUNIT.Button1.Texts[0]", "模块2", "RUNIT.Button1.Texts[1]", "Unit2");
            resources.ApplyTexts(this.m_Button2, "Texts", "RUNIT.Button2.Texts[0]", "模块3", "RUNIT.Button2.Texts[1]", "Unit3");
            resources.ApplyTexts(this.m_Button3, "Texts", "RUNIT.Button3.Texts[0]", "模块4", "RUNIT.Button3.Texts[1]", "Unit4");
            resources.ApplyTexts(this.m_Button4, "Texts", "RUNIT.Button4.Texts[0]", "模块5", "RUNIT.Button4.Texts[1]", "Unit5");
            resources.ApplyTexts(this.m_Text, "Texts", "RUNIT.Text.Texts[0]", "请选择待初始化模块", "RUNIT.Text.Texts[1]", "Please select a unit");
